...
class BootState {
    ...
    render() {
        // Clear the screen
        this.game.layers.ui.clearRect(0, 0, this.game.width, this.game.height);
        
        // Draw loading text
        this.game.layers.ui.fillStyle = 'white';
        this.game.layers.ui.font = '24px Arial';
        this.game.layers.ui.textAlign = 'center';
        this.game.layers.ui.fillText('Initializing...', this.game.width / 2, this.game.height / 2);
    }
